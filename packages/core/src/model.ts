...
export interface PlatinumRecord { id:'__STEAM_TROPHIES_PLATINUM__'; appId:AppId; tier:'platinum'; achieved:boolean; unlockedAtUnix:number|null; name:string; description:string; }
...
export interface GameSnapshot { schemaVersion:1; appId:AppId; name:string; achievements:AchievementRecord[]; platinum:PlatinumRecord; summary:GameSummary; }
